#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/home/daniel/.vscode-server/extensions/wallabyjs.console-ninja-1.0.426/out/buildHook/index.js').default({tool: 'astro', checkSum: '2059730eb99f324bd9a1a5ABcBHQFfAwEJA1EGDAZQDFgAVAYF', mode: 'build'}); } catch(cjsError) { try { import('file:///home/daniel/.vscode-server/extensions/wallabyjs.console-ninja-1.0.426/out/buildHook/index.js').then(m => m.default.default({tool: 'astro', checkSum: '2059730eb99f324bd9a1a5ABcBHQFfAwEJA1EGDAZQDFgAVAYF', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
